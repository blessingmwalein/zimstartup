  ...
  return (
    <DefaultLayout>
      <div className="mx-auto max-w-full px-4">
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center space-y-6 text-white">
            ...
            >
              ...
              >
                {status === "loading" ? <div className="flex flex-row items-center text-center"><Spinner /> Searching...</div> : "Search"}
              </button>
            </form>
        ...
        <Dialog open={dialogVisible} onClose={() => setDialogVisible(false)} className="relative z-50">
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
            <DialogPanel className="max-w-lg space-y-4 rounded-md bg-white p-6 shadow-md text-center">
              <DialogTitle className="font-bold text-lg">Success</DialogTitle>
              <Description>{dialogMessage}</Description>
              <Link
                className="mt-4 px-6 py-2 bg-blue-500 text-white rounded-full hover:bg-blue-600"
                href={`/profile/companies/add-company/step-1`}
              >
