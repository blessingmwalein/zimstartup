...
import { getCustomerData, updateEmploymentInformationAsync } from "../../../../../state/slices/authSlice";
...
const CreateEmployementDetails: React.FC = () => {
    ...
    const { register, handleSubmit, formState: { errors }, setValue } = useForm({
      ...
      defaultValues: {
        ...
        status_of_employment: customerData?.work_details?.status_of_employment || '',
    ...
    useEffect(() => {
      if (customerData?.work_details) {
        ...
        const employerName = customerData?.work_details?.['ce_employer_name'] || '';
        setValue('employer_name', employerName || '');
        setValue('employer_country', customerData.work_details.employer_country || '');
        setValue('status_of_employment', customerData.work_details.status_of_employment || '');
    ...
    const onSubmit = async (data: any) => {
      ...
      const { employer_name, employer_country, status_of_employment, profession, sector } = data;
              ...
              <div className="p-7">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                      <label className="mb-3 block text-sm font-medium text-black dark:text-white" htmlFor="employer_name">
                        Employer Name
                      </label>
                      <input
                      ...
                      />
                      {errors.employer_name && <span className="text-red-500 text-xs">{errors.employer_name.message}</span>}
                    </div>

                    <div>
                      <label className="mb-3 block text-sm font-medium text-black dark:text-white" htmlFor="employer_country">
                        Employer Country
                      </label>
                      <input
                        className="w-full rounded border border-stroke bg-gray py-3 px-4.5 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white"
                      ...
                      />
                      {errors.employer_country && <span className="text-red-500 text-xs">{errors.employer_country.message}</span>}
                    </div>
                  </div>

                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
                    <div>
                      <label className="mb-3 block text-sm font-medium text-black dark:text-white" htmlFor="status_of_employment">
                        Employment Status
                      </label>
                      <input
                        className="w-full rounded border border-stroke bg-gray py-3 px-4.5 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white"
                      ...
                      />
                      {errors.status_of_employment && <span className="text-red-500 text-xs">{errors.status_of_employment.message}</span>}
                    </div>

                    <div>
                      <label className="mb-3 block text-sm font-medium text-black dark:text-white" htmlFor="profession">
                        Profession
                      </label>
                      <input
                        className="w-full rounded border border-stroke bg-gray py-3 px-4.5 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
                    <div>
                      <label className="mb-3 block text-sm font-medium text-black dark:text-white" htmlFor="sector">
                        Sector
                      </label>
                      <input
                        className="w-full rounded border border-stroke bg-gray py-3 px-4.5 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white"
