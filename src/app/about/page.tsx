      ...
      <header className="border-b border-gray-100 py-6">
        <div className="container mx-auto px-4 md:px-8">
          <div className="flex justify-between items-center">
            ...
            <div>
              <button className="bg-black text-white rounded-full px-6 py-2 font-medium hover:bg-gray-800 transition-colors">
                Get Started
              </button>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              ...
              <p className="text-gray-500 mt-2">Connecting startups with opportunities</p>
            </div>
          ...
          <div className="border-t border-gray-200 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-500 mb-4 md:mb-0">© 2024, All Rights Reserved</p>
