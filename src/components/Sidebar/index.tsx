...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      //     { label: "Contact", route: "/profile/contact" },
      //     { label: "Work", route: "/profile/work" },
      //     { label: "Beneficiaries", route: "/profile/beneficiaries" },

      //     { label: "Verification", route: "/profile/verification" },
      //   ],
      // },
      {
        icon: (
      ...
      // },
      {
        ...
        children: [
          ...
          // { label: "Previous Funds", route: "/contact-details" },
          // { label: "Company Updates", route: "/contact-details" },
          // { label: "Sh", route: "/contact-details" },
          // { label: "Contact Details", route: "/contact-details" },
          // { label: "Contact Details", route: "/contact-details" },
        ],
      },
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      <aside
        className={`fixed left-0 top-0 z-99 flex h-screen w-72.5 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:translate-x-0 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"
          }`}
      >
        {/* <!-- SIDEBAR HEADER --> */}
