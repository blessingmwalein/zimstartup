...
export default function MainLayout({
    ...
    return (
        <div className="flex flex-col min-h-screen bg-white">
            {/* Navigation */}
            <header className="sticky top-0 z-50 bg-[#052941] border-b border-gray-100 py-2 text-white shadow-md">
                <div className="container mx-auto px-4 md:px-8">
                    <div className="flex justify-between items-center">
                        {/* <Link href="/" className="text-2xl font-bold text-white">
                            Zim<span className="text-green-500">startup</span>
                        </Link> */}
                        ...
                        {isAuthenticated ? (
                            ...
                            <>
                                <div className="flex items-center space-x-4">
                                    ...
                                    <Link href="/auth/signin" className="hidden md:block text-white text-sm hover:text-white-200 transition-colors">
                                        Login
                                    </Link>
                                    <Link
                                        href="/auth/signup"
                                        className="bg-white text-[#052941] rounded-full px-6 py-2 text-sm font-medium hover:bg-gray-200 transition-colors"
                                    >
                                        Get Started
                                    </Link>
                                </div>
            ...
            {/* Footer */}
            {footerVariant === "full" ? (
                <footer className="bg-[#052941] py-12 border-t border-gray-100 text-white">
                    <div className="container mx-auto px-4 md:px-8">
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                            <div>
                                ...
                                <div className="flex space-x-4 mt-6">
                                    <Link href="#" className="text-gray-400 hover:text-white-600 transition-colors">
                                    ...
                                    <Link href="#" className="text-white-400 hover:text-white-600 transition-colors">
                                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                            <path
                                                fillRule="evenodd"
                            ...
                            <div>
                                ...
                                <ul className="space-y-3">
                                    <li>
                                        <Link href="/about" className="text-white-600 hover:text-white transition-colors">
                                            About Us
                                        </Link>
                                    </li>
                                    {/* <li>
                        ...
                        <div className="border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center">
                            <p className="text-sm text-white-500 mb-4 md:mb-0">© 2024 ZimStartUp. All rights reserved.</p>
                            <div className="flex space-x-6">
                                <Link href="/privacy" className="text-sm text-white-500 hover:text-white-700 transition-colors">
                                    Privacy Policy
                                </Link>
                                <Link href="/terms" className="text-sm text-white-500 hover:text-white-700 transition-colors">
                                    Terms & Conditions
                                </Link>
                                <Link href="/cookies" className="text-sm text-white-500 hover:text-white-700 transition-colors">
                                    Cookie Policy
                                </Link>
                            </div>
                        </div>
                ...
                <footer className="bg-[#052941] py-6 border-t border-gray-100 text-white">
                    <div className="container mx-auto px-4 md:px-8">
