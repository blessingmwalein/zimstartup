...
const ViewStockMarketDetails: React.FC = () => {
      ...
      <div className="mt-4 grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <p className="text-base font-medium text-gray-700">
            <MoneyDisplay amount={stockMarketData.current_market_cap} />
          </p>
          <hr className="my-2" />
        </div>
        ...
        <div>
          ...
          <p className="text-base font-medium text-gray-700">
            <DateDisplay date={stockMarketData.delisted_date} />
          </p>
          <hr className="my-2" />
        </div>
        ...
        <div>
          ...
          <p className="text-base font-medium text-gray-700">
            {stockMarketData.exchange_country}
          </p>
          <hr className="my-2" />
        </div>
        ...
        <div>
          ...
          <p className="text-base font-medium text-gray-700">
            <span className="me-2 rounded border border-blue-400 bg-blue-100 px-2.5 py-0.5 text-xs font-medium text-blue-800 dark:bg-gray-700 dark:text-blue-400">
              {" "}
              {stockMarketData.exchange_currency}
            </span>
          </p>
          <hr className="my-2" />
        </div>
        ...
        <div>
          ...
          <p className="text-base font-medium text-gray-700">
            <MoneyDisplay amount={stockMarketData.listing_capital} />
          </p>
          <hr className="my-2" />
        </div>
        ...
        <div>
          ...
          <p className="text-base font-medium text-gray-700">
            {stockMarketData.transfer_secretary}
          </p>
          <hr className="my-2" />
        </div>
        ...
        <div>
          ...
          <p className="text-base font-medium text-gray-700">
            {stockMarketData.type_of_market}
          </p>
          <hr className="my-2" />
        </div>
      </div>
...
export default ViewStockMarketDetails;
